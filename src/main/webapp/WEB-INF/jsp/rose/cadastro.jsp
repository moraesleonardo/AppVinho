	...
	<div class="container">
		<form action="/rose/incluir" method="post">
			...
			<div class="form-check form-check-inline">
  				<input class="form-check-input" type="radio" name="best_seller" id="inlineRadio1" value="true">
  				<label class="form-check-label" for="inlineRadio1">Best Seller</label>
			</div>
			<div class="form-check form-check-inline">
  				<input class="form-check-input" type="radio" name="best_seller" id="inlineRadio2" value="false">
			...
			<form class="form-inline">
  				...
  				<select class="custom-select my-1 mr-sm-2" name="premios" id="inlineFormCustomSelectPref">
